		...
		<div class="row">
			<div class="span12">
				...
				<div class="well well-small">
					<h3 align="center">View Customers Requests</h3>
					<hr class="soften" />
							...
							<div class="carousel-inner">
								...
								<tbody>
										<tr class="techSpecRow">
											...
											<th class="techSpecTD2">Admin Action</th>
											<th class="techSpecTD2">Acknowledgement</th>
										</tr>
									</tbody>
								<%
								...
								%>
										<tr class="techSpecRow" align="center">
											...
											<td><a class="button" href="ViewProfile.jsp?email=<%=rs1.getString("email")%>&&request_for=<%=rs1.getString("request_for")%>" title="Edit"><input type="submit" value="ViewProfile" class="button"></a></td>
										</tr>
								<%}} %>	
								</table>
								</div>
